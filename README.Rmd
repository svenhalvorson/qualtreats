...
Qualtreats is a library that allows you to easily use data about Qualtrics surveys
...
side-by-side (sbs), or is part of a loop-and-merge. It characterizes the question 
attributes in the column `question_style`. This can accept either the 
...
are ones qualtreats generates. I tried to make some question names and 

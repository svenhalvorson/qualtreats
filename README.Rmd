...
*Huge thank you to authors of [qualtRics](https://github.com/ropensci/qualtRics). Appreciate teaching a bit about `httr`*
...
to be set in the same way that the [qualtRics](https://github.com/ropensci/qualtRics) library uses them:

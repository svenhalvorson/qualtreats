...
#'  \item \code{description_exported}: question description
...
get_column_map = function(
  ...
  if(file_format == 'spss'){
    exported_metadata = qualtreats::get_responses(
      ...
      dplyr::slice(2) %>%
      as.character()
    descriptions_exported = purrr::map_chr(
      .x = exported_columns,
      .f = attr,
      'label'
    )
    ...
    descriptions_exported = as.character(dplyr::slice(exported_columns, 1))
  }
